...
public class Main  {    
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        sprites.add(ImageIO.read(new File("Sprites/minitaur.png")));
        sprites.add(ImageIO.read(new File("Sprites/Minotauro-morrendo.png")));
        sprites.add(ImageIO.read(new File("Sprites/Morcego-voando.png")));
        sprites.add(ImageIO.read(new File("Sprites/Morcego-morrendo.png")));
        sprites.add(ImageIO.read(new File("Sprites/IMP-correndo.png")));
        sprites.add(ImageIO.read(new File("Sprites/IMP-morrendo.png")));        
        sprites.add(ImageIO.read(new File("Sprites/Dragao-voando.png")));        
        sprites.add(ImageIO.read(new File("Sprites/Dragao-morrendo.png")));
        sprites.add(ImageIO.read(new File("Sprites/base1.png")));    
        sprites.add(ImageIO.read(new File("Sprites/torre-ataque.png")));
        sprites.add(ImageIO.read(new File("Sprites/torre-1-idle.png")));
        sprites.add(ImageIO.read(new File("Sprites/base2.png")));  
        sprites.add(ImageIO.read(new File("Sprites/base3.png")));
        sprites.add(ImageIO.read(new File("Sprites/torre-2-idle.png")));
        sprites.add(ImageIO.read(new File("Sprites/torre-1-atacando.png")));
        sprites.add(ImageIO.read(new File("Sprites/torre-2-atacando.png")));
        sprites.add(ImageIO.read(new File("Sprites/background.png")));
