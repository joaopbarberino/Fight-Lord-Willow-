...
public class Window extends JFrame implements KeyListener {
    ...
    public Window(ArrayList<BufferedImage> sprites, Tile_layer layer, ArrayList<Som> sounds) {
        ...
        this.sons = sounds;
        jogador = new Base(710, 25, 10, 0, 180, 0, sprites.get(8), sprites, sons);
    ...
    public void paint(Graphics g) {
        if (!pronto_para_jogar) {
            System.out.println("GAERWTRG");
            g.drawImage(this.sprites.get(16), 0, 0, null);
        } else if (pronto_para_jogar) {
    ...
    public void keyPressed(KeyEvent e
        ...
        if (e.getKeyChar() == 'r') {
            System.out.println("Resetou o jogo!");
        }
    }
